...
const Gallery = props => {
    ...
    // console.log('dataImage dowload', img);
    ...
    const _saveImages = uri => {
        ...
        //         );
        //         // setShowAlert(true);
        //         Alert.alert('sukses menyimpan');
        //     });
    };

    // const onOpen2ndModal = useCallback(img => {
                                ...
                                HeaderComponent={
                                    datas === datas
                                        ? ({imageIndex}) => {
                                              const title = get(
                                                  datas,
                                                  `${imageIndex}.gallery_title`,
                                              );
                                              const ima = get(
                                                  datas,
                                                  `${imageIndex}.gallery_url`,
                                              );
                                              console.log(
                                                  'images gallery url',
                                                  ima,
